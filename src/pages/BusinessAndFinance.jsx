    ...
    <div className="vu-handout-page">
      ...
      <div className="handout-hero">
        <div className="hero-content">
          ...
          <h1>Literature & Languages Materials</h1>
          <p>Complete study materials for Literature and Languages courses.</p>
...
export default LiteratureAndLanguages;
