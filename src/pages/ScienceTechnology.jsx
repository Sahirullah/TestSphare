...
import { scienceTechnologyData, scienceTechnologyCategories } from '../data/scienceTechnologyData';
import './AllBooks.css';

const ScienceTechnology = () => {
  const [selectedCategory, setSelectedCategory] = useState('all');

  const materials = scienceTechnologyData.map(item => ({
    ...item,
  ...
  const categories = scienceTechnologyCategories;
    ...
    <div className="vu-handout-page">
      ...
      <div className="handout-hero">
        <div className="hero-content">
          ...
          <h1>Science & Technology Resources</h1>
          <p>Comprehensive study materials for science and technology courses.</p>
