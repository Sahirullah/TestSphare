...
import { researchInnovationData, researchInnovationCategories } from '../data/researchInnovationData';
import './AllBooks.css';

const ResearchInnovation = () => {
  const [selectedCategory, setSelectedCategory] = useState('all');

  const materials = researchInnovationData.map(item => ({
    ...item,
  ...
  const categories = researchInnovationCategories;
    ...
    <div className="vu-handout-page">
      ...
      <div className="handout-hero">
        <div className="hero-content">
          ...
          <h1>Research & Innovation Resources</h1>
          <p>Comprehensive study materials for research and innovation courses.</p>
