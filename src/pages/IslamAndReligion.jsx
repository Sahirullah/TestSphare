...
import { islamReligionData, islamReligionCategories } from '../data/islamReligionData';
import './AllBooks.css';

const IslamAndReligion = () => {
  const [selectedCategory, setSelectedCategory] = useState('all');

  const materials = islamReligionData.map(item => ({
    ...item,
  ...
  const categories = islamReligionCategories;
    ...
    <div className="vu-handout-page">
      ...
      <div className="handout-hero">
        <div className="hero-content">
          ...
          <h1>Islam & All Religion Materials</h1>
          <p>Complete study materials for Islamic Studies and Religion courses.</p>
...
export default IslamAndReligion;
