...
import { lawPoliticsData, lawPoliticsCategories } from '../data/lawPoliticsData';
import './AllBooks.css';

const LawAndPolitics = () => {
  const [selectedCategory, setSelectedCategory] = useState('all');

  const materials = lawPoliticsData.map(item => ({
    ...item,
  ...
  const categories = lawPoliticsCategories;
    ...
    <div className="vu-handout-page">
      ...
      <div className="handout-hero">
        <div className="hero-content">
          ...
          <h1>Law & Politics Materials</h1>
          <p>Complete study materials for Law and Politics courses.</p>
